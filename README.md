...
pip install git+ssh://git@github.com/stainless-sdks/perplexity-python.git
```
...
```sh
# install from this staging repo
pip install 'perplexity[aiohttp] @ git+ssh://git@github.com/stainless-sdks/perplexity-python.git'
```
...
These methods return an [`APIResponse`](https://github.com/stainless-sdks/perplexity-python/tree/main/src/perplexity/_response.py) object.

The async client returns an [`AsyncAPIResponse`](https://github.com/stainless-sdks/perplexity-python/tree/main/src/perplexity/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/perplexity-python/issues) with questions, bugs, or suggestions.
