...
The REST API documentation can be found on [docs.perplexity.ai](https://docs.perplexity.ai/). The full API reference for this library can be found in [api.md](api.md).
