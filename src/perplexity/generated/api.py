...
class ChatCompletionsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        _inputs: Union[Union[list[int], None], Omit] = omit,
        ...
        image_domain_filter: Union[Union[list[str], None], Omit] = omit,
        image_format_filter: Union[Union[list[str], None], Omit] = omit,
        ...
        search_domain_filter: Union[Union[list[str], None], Omit] = omit,
        search_internal_properties: Union[Union[dict[str, Any], None], Omit] = omit,
        search_language_filter: Union[Union[list[str], None], Omit] = omit,
        ...
        stop: Union[Union[str, list[str], None], Omit] = omit,
        ...
        tools: Union[Union[list["ToolSpecInput"], None], Omit] = omit,
        ...
        web_search_options: Union["WebSearchOptionsInput", Omit] = omit,
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
        extra_body: Body | None = None,
        timeout: float | Timeout | None | NotGiven = not_given,
...
class ResponsesResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        models: Union[list[str], Omit] = omit,
        preset: Union[str, Omit] = omit,
        previous_response_id: Union[str, Omit] = omit,
        reasoning: Union["ReasoningConfigInput", Omit] = omit,
        response_format: Union["ResponseFormatInput", Omit] = omit,
        skills: Union[list["SkillInput"], Omit] = omit,
        store: Union[bool, Omit] = omit,
        stream: Union[bool, Omit] = omit,
        tools: Union[list["ToolInput"], Omit] = omit,
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
        extra_body: Body | None = None,
        timeout: float | Timeout | None | NotGiven = not_given,
