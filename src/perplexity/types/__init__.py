...
from .shared import (
    ...
    EmbeddingObject as EmbeddingObject,
...
from .contextualized_embedding_create_response import (
    ContextualizedEmbeddingCreateResponse as ContextualizedEmbeddingCreateResponse,
)
